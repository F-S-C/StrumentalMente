...
Il committente dell’applicazione è il docente del corso di Progettazione e Produzione Multimediale dell’anno 2018/19 dell’Università di Bari (CdL\footnote{CdL: abbreviazione dii ``Corso di Laurea''.}: Informatica e Comunicazione Digitale), la Prof.ssa \emph{Rosa Lanzilotti}.
