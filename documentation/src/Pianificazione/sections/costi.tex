...
La distribuzione del lavoro nel team di progettazione di sviluppo del sistema è stato diviso nel seguento modo:
\begin{itemize}
...
Nello sviluppo dell'applicazione sono stati utilizzati i seguenti applicativi:
\begin{itemize}
