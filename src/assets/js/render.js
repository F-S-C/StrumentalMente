...
function setShortcuts(doc = document) {
	if (!shortcutDisabled) {
		...
		Mousetrap.bind("alt+s c", () => { warnIfIncomplete('base', 'teoria base', 'agli strumenti', () => { parent.window.location.href = "./index.html?started=true&topic=./teoria-chitarra.html&to-home=false"; }); });
		Mousetrap.bind("alt+s b", () => { warnIfIncomplete('base', 'teoria base', 'agli strumenti', () => { parent.window.location.href = "./index.html?started=true&topic=./teoria-basso.html&to-home=false"; }); });
		Mousetrap.bind("alt+s shift+b", () => { warnIfIncomplete('base', 'teoria base', 'agli strumenti', () => { parent.window.location.href = "./index.html?started=true&topic=./teoria-batteria.html&to-home=false"; }); });
		Mousetrap.bind("alt+s p", () => { warnIfIncomplete('base', 'teoria base', 'agli strumenti', () => { parent.window.location.href = "./index.html?started=true&topic=./teoria-piano.html&to-home=false"; }); });
		Mousetrap.bind("alt+a a", () => { parent.document.querySelector("#chords-nav-link>button").click(); });
		Mousetrap.bind("alt+a c", () => { warnIfIncomplete('chitarra', 'teoria della chitarra', 'agli accordi della chitarra', () => { parent.window.location.href = "./index.html?started=true&topic=./accordi-chitarra.html&to-home=false"; }); });
		Mousetrap.bind("alt+a b", () => { warnIfIncomplete('basso', 'teoria del basso', 'agli accordi del basso', () => { parent.window.location.href = "./index.html?started=true&topic=./accordi-basso.html&to-home=false"; }); });
		Mousetrap.bind("alt+a p", () => { warnIfIncomplete('piano', 'teoria del pianoforte', 'agli accordi del pianoforte', () => { parent.window.location.href = "./index.html?started=true&topic=./accordi-piano.html&to-home=false"; }); });
