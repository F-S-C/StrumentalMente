(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		factory(require('jquery')); // Modified by Andrea Esposito (@espositoandrea)
	}
})(this, function ($) {
	...
	$.fn.maphilight = function (opts) {
		...
		return this.each(function () {
			...
			wrap = $('<div></div>').css({
				...
				width: this.width,
				height: this.height,
				margin: '0 auto' //Modified by Andrea Esposito (@espositoandrea)
			});
	...
	// Modified by Andrea Esposito (@espositoandrea)
