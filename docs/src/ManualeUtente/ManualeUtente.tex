\documentclass[a4paper,11pt,leqno,openbib,oldfontcommands, twocolumn, openright]{memoir}
...
\renewcommand\printchaptertitle[1]{\chaptitlefont\raggedleft ##1\\\rule{\textwidth}{0.5pt}\par}
}
\chapterstyle{my}
